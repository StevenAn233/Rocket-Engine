...
## Building
The project uses **CMake** and **vcpkg** as building support.
On **Windows**, MSVC is the first(now the only) choice as the C++ compiler.
...
Run `RocketEngine.exe`, press **File -> New Project**. You don't need to close the editor. Open the generated `CMakeLists.txt` with **Visual Studio 2026**, you can write codes in it and build the script project. Then press the **Reload Script** button on the toolbar of the editor, your scripts are good to use.
